...
using Allegro.Aduos.Gaska.OrdersService;
using Allegro.Aduos.Gaska.OrdersService.Settings;
using DbUp;
...
var host = Host.CreateDefaultBuilder(args)
    ...
    {
        options.ServiceName = "GaskaAllegroOrdersSyncService";
    })
    .ConfigureServices((hostContext, services) =>
    {
        ...
        // Services
        services.AddScoped<IAllegroOrderSyncService, AllegroOrderSyncService>();
